...
load(file = paste0(wd, '/data/GPT_3.5.Rdata'))
```
...
"... give me 5 or fewer scientific literature references to further my understanding" about XYZ-123." <sub>see method below for full propmts</sub> .
...
"For the text below, give me 5 or fewer scientific literature references to further my understanding. Answer only with article title. Do not elaborate. Do not include authors. Separate by new line. Text:\n"
